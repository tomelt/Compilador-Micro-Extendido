...
TOKEN scanner()
{
    int tabla[NUMESTADOS][NUMCOLS] =
        //L   D   +   -   (   )   .   ,   ;   :   '   =   EOF ´ ´ OTRO
        {{1,  3,  5,  6,  7,  8,  16, 10, 12, 13, 1 ,16, 15, 0,  16},
         {1,  1,  2,  2,  2,  2,  16, 2,  2,  2,  2 ,2,  2,  2,  2 },
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,16, 16, 16, 16},
         {4,  3,  4,  4,  4,  4,  3, 4,  4,  4,   16 ,4,  4,  4,  4 },
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,16, 16, 16, 16},
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,16, 16, 16, 16},
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,16, 16, 16, 16}, //AGREGADA .
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,16, 16, 16, 16},
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,16, 16, 16, 16},
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,16, 16, 16, 16},
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,16, 16, 16, 16}, // agregada '
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,16, 16, 16, 16},
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,16, 16, 16, 16},
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,14, 16, 16, 16},
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,16, 16, 16, 16},
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,16, 16, 16, 16},
         {16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16 ,16, 16, 16, 16}};
    int car;
    ...
    } while (!estadoFinal(estado) && !(estado == 16));
